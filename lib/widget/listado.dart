          ...
          children: <Widget>[
            Container(
              ...
              child: Column(
                ...
                children: <Widget>[
                  FaIcon(FontAwesomeIcons.futbol,size: 45,),
              ...
              child: Container(
                child: Column(
                  ...
                  children: <Widget>[
                    ...
                    SizedBox(height: 10,),
                    Text('Deportivo Futgol',style: TextStyle(fontSize: 20,fontWeight: FontWeight.bold),),
                    SizedBox(height: 10,),
                    Text('8:00 AM',style: TextStyle(fontSize: 18),),
                  ],
                ),
              ),
            ),
            Container(
              ...
              child: Text('Pediente',style: TextStyle(color: Colors.orange,fontWeight: FontWeight.bold),),
            ),
          ],
        ),
      ),
